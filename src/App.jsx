...
export default function App() {
  // State variables for the live interactive simulator
  ...
  // Add pledge value to capacity (interactive simulation)
  ...
  return (
    <div className="relative min-h-screen bg-brand-light selection:bg-brand-parrot selection:text-brand-dark">
      ...
      {/* 4. Live Funding Tracker (Progress Circle & Project Stats) */}
      <LiveFundingTracker
        filled={filledCapacity}
        total={targetCapacity}
        available={remainingCapacity}
